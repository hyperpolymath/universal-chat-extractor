{
  description = "universal-chat-extractor - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 universal-chat-extractor development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "universal-chat-extractor";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P universal-chat-extractor.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/universal-chat-extractor $out/bin/  # Rust
            # cp bin/universal-chat-extractor $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/universal-chat-extractor";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-universal-chat-extractor" {
