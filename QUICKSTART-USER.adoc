...
// Replace universal-chat-extractor, Universal Chat Extractor — See README.adoc for details., just run, Universal Chat Extractor started successfully. with actuals
= universal-chat-extractor — Quick Start for Users
:toc:
:toclevels: 2

== What is universal-chat-extractor?

Universal Chat Extractor — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./universal-chat-extractor-portable
----
...
[source]
----
Universal Chat Extractor started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/universal-chat-extractor/wiki
